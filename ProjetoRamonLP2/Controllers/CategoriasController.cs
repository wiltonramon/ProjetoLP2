...
namespace ProjetoRamonLP2.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoCategoria,NomeCategoria")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoCategoria,NomeCategoria")] Categoria categoria)
        {
            if (ModelState.IsValid)
            {
